...
<body>
  ...
  <!--Admin Navigation Bar-->
	...
	<nav style="height: 30px; line-height:  30px;">
        ...
        <li><a href="#!">STAFF ACCOUNT INFORMATION</a></li>
      </ul>
		</div>
	</nav>
	...
	<div class="container" style="width: 60%;">
		<table class="highlight">
			...
			<?php
				...
				$retrieve = "SELECT * FROM staff";
				$view_query = mysqli_query($connections, $retrieve);

				while($row = mysqli_fetch_assoc($view_query))
				{
					$user_id = $row["staffID"];
					$db_first_name = $row["staffFirstName"];
					$db_middle_name = $row["staffMiddleName"];
					$db_last_name = $row["staffLastName"];
					$db_username = $row["staffUserName"];
...
<!--Add Customer Button-->
  <div class="fixed-action-btn tooltipped" data-position="left" data-delay="0" data-tooltip="Add Record">
    <a class="btn-floating btn-large red" href="add_staff.php">
